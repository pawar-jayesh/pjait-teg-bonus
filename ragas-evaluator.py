...
# LangChain and RAGAS related imports
...
def load_config():
    ...
    if not openai_api_key:
        raise ValueError("Missing OPENAI_API_KEY_TEG environment variable.")
...
def generate_qa_pairs(paper_text, api_key):
...
def main():
    ...
    qa_pairs = generate_qa_pairs(paper_text, openai_api_key)
